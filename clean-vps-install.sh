...
echo "🧹 NETTOYAGE COMPLET DU VPS - RÉINSTALLATION PROPRE"
echo "=================================================="
...
echo "🛑 Étape 1: Arrêt de tous les conteneurs..."
docker compose down --volumes --remove-orphans

echo "🗑️ Étape 2: Suppression de tous les volumes Docker..."
docker volume prune -f
docker volume rm $(docker volume ls -q) 2>/dev/null || true

echo "🗑️ Étape 3: Suppression de toutes les images Docker..."
docker image prune -a -f
docker rmi $(docker images -q) 2>/dev/null || true

echo "🧹 Étape 4: Nettoyage complet du système Docker..."
docker system prune -a -f --volumes

echo "📥 Étape 5: Récupération du code depuis Git..."
git fetch origin
git reset --hard origin/main
git clean -fd

echo "🔨 Étape 6: Construction et démarrage des conteneurs..."
docker compose up -d --build

echo "⏳ Étape 7: Attente du démarrage de la base de données..."
sleep 30

echo "📊 Étape 8: Vérification du statut des conteneurs..."
docker compose ps

echo "🗄️ Étape 9: Initialisation de la base de données avec les données par défaut..."
...
echo "📊 Vérification finale du statut..."
docker compose ps
...
echo "=========================="
echo ""
echo "✅ Tous les conteneurs sont redémarrés"
