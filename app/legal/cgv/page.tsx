...
export default async function CGVPage() {
  ...
  const legalPage = await getLegalPageByType('cgv')
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (legalPage) {
    return {
      ...
      description: legalPage.meta_description || 'Conditions générales de vente de U Silenziu',
      keywords: legalPage.keywords?.join(', ') || 'CGV, conditions générales, vente, U Silenziu'
    }
  }
  
  return {
    title: 'Conditions Générales de Vente - U Silenziu',
    description: 'Conditions générales de vente de U Silenziu, zone de défoulement à Buros'
  }
}